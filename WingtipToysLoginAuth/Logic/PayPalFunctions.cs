...
using System.Web;
using WingtipToysLoginAuth;
using WingtipToysLoginAuth.Models;
...
public class NVPAPICaller
{
    ...
    public string APIUsername = "sb-wfgwk5799199_api1.business.example.com";
    private string APIPassword = "JNAT9K3WUV9JP53V";
    private string APISignature = "ASEOXq.iS7QCI5UDJ3vaVa8vkd2mAxy0vCgphIL1mwFU7F3WrY05tzv0";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        using (WingtipToysLoginAuth.Logic.ShoppingCartActions myCartOrders = new WingtipToysLoginAuth.Logic.ShoppingCartActions())
        {
