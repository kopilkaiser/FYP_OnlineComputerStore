<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddReviewForProduct.aspx.cs" Inherits="FrontEnd.WebForm21" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        <table class="nav-justified">
            ...
            <tr>
                <td style="width: 386px" class="text-right">&nbsp;</td>
                <td>
                    &nbsp;</td>
                <td>&nbsp;</td>
            </tr>
            ...
            <tr>
                ...
                <td>
            &nbsp; <asp:TextBox ID="txtProductId" runat="server" ReadOnly="True" Width="70px"></asp:TextBox>
                </td>
                <td>&nbsp;</td>
            </tr>
