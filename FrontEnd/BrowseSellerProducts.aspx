...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblShopName.Text = Convert.ToString(userEmail);
    }
    ...
    <div class="text-left">   
       ...
       %>
                ...
                <div ID="PageTitle" class="text-center">  <span style="font-family: Arial; font-size: x-large; text-transform: uppercase; letter-spacing: 3px">Browse <asp:Label ID="lblSellerName" runat="server" style="color: #800000"></asp:Label> &nbsp;Shop</span><span style="font-family: Arial; font-size: xx-large; text-transform: uppercase; letter-spacing: 3px"><br />
